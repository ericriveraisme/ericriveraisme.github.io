...
export const resumeData = {
  ...
  featured: {
    ...
    emoji: "🔮",
    description: "The ultimate grimoire for the public documentation of my home lab (virtual data center) with a focus on infrastructure as code (IaC), network automation, and hybrid identity. This project serves as a living portfolio of my hands-on experience and technical expertise in IT systems administration.",
