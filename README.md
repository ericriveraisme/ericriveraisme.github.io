...
- Visual data flow diagram (Raw Data → Secure Hash)
...
├── index.html                              # Main portfolio (v2.2)
├── WhitePaper.html                         # Technical documentation
├── OnePageSelfAuditFlyer.html             # Self-assessment tool
...
├── index-old.html                          # Legacy scanline design
├── index-var-indust.html                   # Industry variant
...
© 2025 Delta Data Defense LLC. All rights reserved.
